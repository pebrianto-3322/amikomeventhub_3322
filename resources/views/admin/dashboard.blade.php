...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
    ...
    <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        ...
        <h3 class="text-2xl font-black">{{ \App\Models\Event::count() }} Event</h3>
    </div>
    <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y border-t">
                <tr class="hover:bg-slate-50 transition">
                    <td class="px-8 py-6"><p class="font-bold text-sm">Donni Prabowo</p><p class="text-xs text-slate-400">donni@example.com</p></td>
                ...
                <tr class="hover:bg-slate-50 transition">
                    <td class="px-8 py-6"><p class="font-bold text-sm">Maya Sari</p><p class="text-xs text-slate-400">maya@example.com</p></td>
                ...
                <tr class="hover:bg-slate-50 transition">
                    <td class="px-8 py-6"><p class="font-bold text-sm">Budi Santoso</p><p class="text-xs text-slate-400">budi@example.com</p></td>
