...
<main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
    ...
    <div class="lg:col-span-1">
        <div class="sticky top-32">
            <img src="{{ $event->poster_path ? asset($event->poster_path) : 'https://placehold.co/400x500/e2e8f0/94a3b8?text=No+Image' }}" alt="{{ $event->title }}" class="w-full rounded-[2.5rem] shadow-2xl border-8 border-white">
        ...
        <div class="bg-indigo-600 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl shadow-indigo-200 relative overflow-hidden">
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                <div>
                    ...
                    <p class="mt-4 text-indigo-100 flex items-center gap-2">Sisa stok: <span class="font-bold underline">{{ $event->stock }} Tiket lagi!</span></p>
                </div>
                <div>
                    <a href="{{ route('checkout.create', $event->id) }}" class="inline-block px-10 py-5 bg-white text-indigo-600 rounded-2xl font-black text-xl hover:scale-105 transition-transform shadow-xl">Pesan Sekarang</a>
                </div>
            </div>
